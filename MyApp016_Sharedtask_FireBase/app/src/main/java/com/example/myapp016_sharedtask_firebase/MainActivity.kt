...
import com.example.myapp016_sharedtask_firebase.databinding.ActivityMainBinding
    ...
    private fun loadTasksFromFirestore() {
        firestore.collection("tasks").get()
            ...
            .addOnFailureListener { e ->
                println("Error loading tasks: ${e.message}") // Lze přidat log nebo zobrazení uživateli
            }
    }
